...
namespace GameEngineLib{
	...
	public:
		...
		static Matrix4x4 rotate(float _angle, Vector3& _rotEuler);
		static Matrix4x4 rotate(Matrix4x4 _m, float _angle, Vector3& _rotEuler);

		static Matrix4x4 translate(float _x, float _y, float _z);
		static Matrix4x4 translate(Vector3& _v3);
		static Matrix4x4 translate(Matrix4x4& _m, Vector3& _v3);

		static Matrix4x4 scale(float x, float y, float z);
		static Matrix4x4 scale(Vector3& _v3);
		static Matrix4x4 scale(Matrix4x4 _m, Vector3& _v3);
